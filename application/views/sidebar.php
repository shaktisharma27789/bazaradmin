...
<div class="page-container row">
  <!-- BEGIN SIDEBAR -->
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      ...
      <ul>
        ...
        <li > <a href="<?php echo base_url();?>category/displayCategory" > <i class="fa fa-th"></i> <span class="title">Category</span> </a> </li>

        <li > <a href="<?php echo base_url();?>category/displaysubCategory"> <i class="fa fa-th"></i> <span class="title">Sub Category</span> </a> </li>
        
        <li > <a href="<?php echo base_url();?>Region/loadRegion"> <i class="fa fa-th"></i> <span class="title">Add City Region</span> </a> </li>
        ...
        <li > <a href="javascript:;"> <i class="fa fa fa-adjust"></i> <span class="title">Users</span> <span class=" arrow" ></span> </a>
            <ul class="sub-menu">
            
                 <li > <a href="<?php echo base_url();?>Bazarusers/displayUsers?role=user">Normal </a> </li>
                 <li > <a <a href="<?php echo base_url();?>Bazarusers/displayUsers?role=retailer">Retailer </a> </li>
                 <li > <a <a href="<?php echo base_url();?>Bazarusers/displayUsers?role=wholesler">Wholesler </a> </li>
                 <li > <a href="<?php echo base_url();?>Bazarusers/displayUsers?role=manufeturer">Manufeture </a> </li>
			  
            </ul>
        </li>

        <li > <a href="javascript:;"> <i class="fa fa fa-adjust"></i> <span class="title">Manage Location</span> <span class=" arrow" ></span> </a>
            <ul class="sub-menu">
                 <li > <a href="<?php echo base_url();?>ManageLocation/displayCity">View City </a> </li>
                 <li > <a <a href="<?php echo base_url();?>Bazarusers/displayUsers?role=retailer">View Area </a> </li>
             </ul>
        </li>
  ...
  <div class="footer-widget">
    ...
    <div class="pull-right">
      ...
      <?php echo anchor('user/logout', 'Logout'); ?><i class="fa fa-power-off"></i></a></div>
  </div>
  <!-- END SIDEBAR